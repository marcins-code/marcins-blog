export const errorsMessages = {
  missingLang: "Please provide 'lang' parameter. Can be 'pl' or 'en'",
  ...
  missingAuthorization: 'Operation requires authorization',
  invalidToken: 'Invalid jwt token',
  invalidLang: "Invalid language. Can be 'pl' or 'en'",
